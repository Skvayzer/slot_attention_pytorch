#!/bin/bash -l
#SBATCH --job-name=quantised_sa_od_tetrominoes_scale_-1to1_17_17_17_17__seed42_end_to_end
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
singularity instance start \
                     ...
                     /home/AI/yudin.da/smirnov_cv/quantised_sa/ml_env.sif ml_env5
...
singularity exec instance://ml_env5 /bin/bash -c "
      ...
      free -m;
      cd /home/smirnov_cv;
      python3 slot_attention_pytorch/src/sa_autoencoder/train.py --mode "tetrominoes" --path_to_dataset "/home/smirnov_cv/quantised_sa/datasets/multi_objects/tetrominoes" --device 0 --batch_size 64 --max_epochs 1000 --seed 42
      free -m;
";
